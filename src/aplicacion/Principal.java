...
public class Principal{
	public static void main(String[] args) {
		...
		ProfesorTitular pt1 = new ProfesorTitular("Marcos");
		...
		//Se procede con el catedrático de forma análoga a como se ha procedido con el profesor titular.
		...
		System.out.println("La valoración de profesor titular "+ "pt1 es " +pt1.calcularValoracion());System.out.println("La valoración del catedrático ct1es "+ ct1.calcularValoracion());}}
